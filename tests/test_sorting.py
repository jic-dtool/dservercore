...
def test_sort_parameters(tmp_app_with_dummy_sort_blueprint_client):
    ...
    assert data[0] == {'display_name': None, 'is_admin': False, 'username': 'grumpy'}
    assert data[1] == {'display_name': None, 'is_admin': False, 'username': 'sleepy'}
    assert data[2] == {'display_name': None, 'is_admin': True, 'username': 'snow-white'}
    ...
    assert data[0] == {'display_name': None, 'is_admin': True, 'username': 'snow-white'}
    assert data[1] == {'display_name': None, 'is_admin': False, 'username': 'grumpy'}
    assert data[2] == {'display_name': None, 'is_admin': False, 'username': 'sleepy'}
    ...
    assert data[0] == {'display_name': None, 'is_admin': True, 'username': 'snow-white'}
    assert data[1] == {'display_name': None, 'is_admin': False, 'username': 'sleepy'}
    assert data[2] == {'display_name': None, 'is_admin': False, 'username': 'grumpy'}
    ...
    assert data[0] == {'display_name': None, 'is_admin': False, 'username': 'sleepy'}
    assert data[1] == {'display_name': None, 'is_admin': False, 'username': 'grumpy'}
    assert data[2] == {'display_name': None, 'is_admin': True, 'username': 'snow-white'}
